...
#ifndef PATHPLANNER_MRPT_TEST__H
#define PATHPLANNER_MRPT_TEST_H
  ...
  : public RTC::DataFlowComponentBase
{
 public:
   ...
   */
  PathPlanner_MRPTTest(RTC::Manager* manager);

  /*!
   * @brief destructor
   */
  ~PathPlanner_MRPTTest();
 ...
 protected:
  ...
  /*!
   * 
   * - Name:  goalHeadingTolerance
   * - DefaultValue: 0.5
   */
  float m_goalHeadingTolerance;
  /*!
   * 
   * - Name:  goalDistanceTolerance
   * - DefaultValue: 0.5
   */
...
extern "C"
{
  DLL_EXPORT void PathPlanner_MRPTTestInit(RTC::Manager* manager);
};

#endif // PATHPLANNER_MRPT_TEST_H
